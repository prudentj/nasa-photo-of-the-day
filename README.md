...
- [x] Go to the [NASA APOD API docs](https://api.nasa.gov/#apod) and read through the docs to see how to make the API call. q1G4vDCuPuuyAUVa2Z7EfNmRd7I6Lgrqs5qJj9nB is API key
https://api.nasa.gov/planetary/apod?api_key=q1G4vDCuPuuyAUVa2Z7EfNmRd7I6Lgrqs5qJj9nB
